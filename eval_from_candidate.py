...
recording_candidate = 'R10_6.28.16_BALBC_IL1B(35ngperkg)_TNF(0.5ug)_03'
# General: 
...
#recording = '4.6.16_TRPV1-KO_IL1B(350ngPerkg)_05'
#recording = 'IL1RKO_TNF--IL1B_5.3.2016_07'
...
unique_start_string = '5_dec_cytokine_candidate'
#unique_string_for_run = 'aa_using_new_var_period_3_test_4_dec'+recording
unique_string_for_run = '5_dec_ds4'+recording


# FOR SAVING FIGURES ****Not allowed to contain . or () signs****
#unique_string_for_figs = '5_dec_cytokine_candidate'+'R10_6_27_16_BALBC_IL1B_35ngperkg_TNF_05ug_01' 
#unique_string_for_figs = '5_dec_cytokine_candidate'+'R10_6_27_16_BALBC_TNF_0_5ug_IL1B_35ngperkg_01'
#unique_string_for_figs = '5_dec_cytokine_candidate'+'R10_6_28_16_BALBC_IL1B_35ngperkg_TNF_05ug_03'
#unique_string_for_figs =  '5_dec_cytokine_candidate'+'R10_6_28_16_BALBC_TNF_05ug_IL1B_35ngperkg_02'
...
path_to_cytokine_candidate = '../numpy_files/cytokine_candidates/'+'5_dec_nstd_02and01_ds4' + recording_candidate
...
load_data = True
if load_data:
    wf0 = load_waveforms(path_to_wf,'waveforms', verbose=1)
    ts0 = load_timestamps(path_to_ts,'timestamps',verbose=1)
